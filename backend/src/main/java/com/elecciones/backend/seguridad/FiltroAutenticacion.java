...
public class FiltroAutenticacion extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        userEmail = jwtUtilidad.extractEmail(jwt);

        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = this.servicioDetalleUsuario.loadUserByUsername(userEmail);

            if (jwtUtilidad.validateToken(jwt, userDetails)) {
